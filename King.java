...
public class King extends Figure {
    ...
    boolean p1checkMove(Object[][] chessBoard, int takeRow, int takeColumn, int putRow, int putColumn) {
        if (chessBoard[takeRow][takeColumn] != p1whiteFigure() || p1KingChecked(chessBoard) || takeRow == putRow && takeColumn == putColumn)
            return false;
        if (!wkIsMoved) {
            if (putRow == 1 && takeRow == 1 && takeColumn - putColumn == 2 && chessBoard[1][1] == "w.R" && !p1KingChecked(chessBoard)) {
                while (takeColumn > 2) {
                    takeColumn--;
                ...
                return true;
            } else if (putRow == 1 && takeRow == 1 && takeColumn - putColumn == -2 && chessBoard[1][8] == "w.R" && !p1KingChecked(chessBoard)) {
                while (takeColumn < 7) {
                    takeColumn++;
                    if (chessBoard[1][takeColumn] != null)
                        return false;
    ...
    boolean p2checkMove(Object[][] chessBoard, int takeRow, int takeColumn, int putRow, int putColumn) {
        if (chessBoard[takeRow][takeColumn] != p2blackFigure() || p2KingChecked(chessBoard) || takeRow == putRow && takeColumn == putColumn)
            return false;
        if (!bkIsMoved) {
    ...
    boolean p1ValidMoves(Object[][] chessBoard) {
        for (int i = 1; i < chessBoard.length-1; i++) {
            for (int j = 1; j < chessBoard[1].length-1; j++) {
                if ((chessBoard[i][j] == "w.K")) {
                    try {
                        if ((chessBoard[i + 1][j] == null || chessBoard[i + 1][j].toString().charAt(0) == 'b') && !p1KingChecked(chessBoard))
                            return true;
                    } catch (ArrayIndexOutOfBoundsException ignore) {
                    }
                    try {
                        if ((chessBoard[i + 1][j - 1] == null || chessBoard[i + 1][j - 1].toString().charAt(0) == 'b') && !p1KingChecked(chessBoard))
                            return true;
                    } catch (ArrayIndexOutOfBoundsException ignore) {
                    }
                    try {
                    ...
                    try {
                        if ((chessBoard[i][j - 1] == null || chessBoard[i][j - 1].toString().charAt(0) == 'b') && !p1KingChecked(chessBoard))
                            return true;
                    } catch (ArrayIndexOutOfBoundsException ignore) {
                    }
                    try {
    ...
    boolean p2ValidMoves(Object[][] chessBoard) {
        for (int i = 1; i < chessBoard.length-1; i++) {
            for (int j = 1; j < chessBoard[1].length-1; j++) {
                if ((chessBoard[i][j] == "b.K")) {
                    try {
                        if ((chessBoard[i + 1][j] == null || chessBoard[i + 1][j].toString().charAt(0) == 'w') && !p1KingChecked(chessBoard))
                            return true;
                    } catch (ArrayIndexOutOfBoundsException ignore) {
                    }
                    try {
                        if ((chessBoard[i + 1][j - 1] == null || chessBoard[i + 1][j - 1].toString().charAt(0) == 'w') && !p1KingChecked(chessBoard))
                            return true;
                    } catch (ArrayIndexOutOfBoundsException ignore) {
                    }
                    try {
                    ...
                    try {
                        if ((chessBoard[i][j - 1] == null || chessBoard[i][j - 1].toString().charAt(0) == 'w') && !p1KingChecked(chessBoard))
                            return true;
                    } catch (ArrayIndexOutOfBoundsException ignore) {
                    }
                    try {
